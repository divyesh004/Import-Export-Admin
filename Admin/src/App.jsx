...
const PrivateRoute = ({ children }) => {
  ...
  // Restrict sub-admin from accessing user management page
  if (userRole === 'sub-admin' && location.pathname === '/users') {
    return (
      <Box 
        sx={{ 
          p: 4, 
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" paragraph sx={{ fontSize: '1.1rem', mb: 3 }}>
            Sorry, as a sub-admin you do not have permission to access the User Management page.
          </Typography>
