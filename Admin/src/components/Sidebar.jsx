...
const menuItems = [
  ...
  { text: 'Product Moderation', icon: <InventoryIcon />, path: '/products' },
  { text: 'Approved Products', icon: <InventoryIcon />, path: '/approved-products' },
  { text: 'Analytics', icon: <BarChartIcon />, path: '/analytics' },
  { text: 'Role Management', icon: <AdminPanelSettingsIcon />, path: '/roles' },
  { text: 'Q&A Management', icon: <QuestionAnswerIcon />, path: '/questions/all' },
